...
function ENT:SetupDataTables()
	self:NetworkVar("Bool", 0, "Locked", {KeyName = "Locked", Edit = {type = "Bool", order = 1}})
	self:NetworkVar("Bool", 1, "DisplayError")
	self:NetworkVar("String", 0, "Access", {KeyName = "Access", Edit = {type = "String", order = 2}})
...
if (SERVER) then
	...
	function ENT:SpawnFunction(client, trace)
		...
		position = position or trace.HitPos
