ix.LootContainer:Add("garbage", { -- garbage tier 0
	...
	LootGroup = {
		garbage = {
			...
			{ id = "mat_wood", weight = 50, min = 1, max = 3 },
			{ id = "mat_charcoal", weight = 50, min = 1, max = 2 },
...
ix.LootContainer:Add("dumpster", { -- garbage tier 2
	...
	LootGroup = {
		...
		small = {
			...
			{ id = "canned_dogfood", weight = 35 },
			{ id = "dirty_water", weight = 35 },
			{ id = "mat_wood", weight = 30, min = 1, max = 3 },
			{ id = "mat_charcoal", weight = 30 },
...
ix.LootContainer:Add("supply_crate", { -- resource crate
	...
	LootGroup = {
		regular = {
			...
			{ id = "mat_wood", weight = 50, min = 2, max = 4 },
			{ id = "mat_charcoal", weight = 50, min = 1, max = 2 },
			...
			{ id = "mat_wood", weight = 60, min = 2, max = 4 },
			{ id = "empty_can", weight = 50 },
			{ id = "empty_chinese_takeout", weight = 50 },
			{ id = "empty_carton", weight = 50 },
			{ id = "empty_tin_can", weight = 50 },
...
ix.LootContainer:Add("military_crate", { -- military tier 0
	...
	LootGroup = {
		...
		regular = {
			...
			{ id = "respirator_af", weight = 4 },
			{ id = "gasmask_gp7", weight = 3 },
			{ id = "mat_armor_tier1", weight = 15 },
			{ id = "filter_standard", weight = 13 },
			{ id = "filter_good", weight = 13 },
			{ id = "filter_medium", weight = 13 },
			{ id = "mat_charcoal", weight = 2, min = 2, max = 4 },
			{ id = "filter_epic", weight = 13 },
			{ id = "junk_gloves", weight = 15 },
			{ id = "gun_pistol_barrel", weight = 10 },
			{ id = "gun_weapon_barrel", weight = 10 },
			...
			{ id = "gun_shotgun_frame", weight = 10 },
			{ id = "gun_smg_frame", weight = 10 },
			{ id = "gun_smg_grip", weight = 10 },
			{ id = "gun_pistol_frame", weight = 10 },
			{ id = "gun_pistol_receiver", weight = 10 },
		},
	},
	Loot = {
		{ lootGroup = "raw", count = 2 },
		{ lootGroup = "medicine", count = 2 },
		{ lootGroup = "mil", count = 2 },
		{ lootGroup = "regular", count = 4 }
	}
})
