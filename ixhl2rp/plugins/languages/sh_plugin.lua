...
ix.char.RegisterVar("languages", {
	...
	isLocal = true,
	bNoDisplay = true,
	OnValidate = function(self, languages, data, client)
		local count = 0
		for k, langID in ipairs(languages or {}) do
			local lang = ix.languages.stored[langID]

			if !lang or lang.notSelectable then
				return false
			end
