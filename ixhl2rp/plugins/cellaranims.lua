...
ix.anim.SetModelClass("models/jq/hlvr/characters/combine_soldier/combine_soldier_new_content_player.mdl", "cellarMale")
...
ix.anim.SetModelClass("models/vintagethief/shein2.mdl", "cellarMale")
...
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/female_oberg.mdl", "cellarFemale")
ix.anim.SetModelClass("models/earl_krutoi/female_oberg.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/characters/city3/citizens/sb/vector.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/cellar/characters/male_russian_hero.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/pepsi.mdl", "cellarMale")
ix.anim.SetModelClass("models/kruppzo/unnamed.mdl", "cellarMale")
ix.anim.SetModelClass("models/kruppzo/emele.mdl", "cellarFemale")

ix.anim.SetModelClass("models/metrocop/zandronum/metrocop_zand.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/kruppzo/mpf_5254.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/kruppzo/mpf_2048.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/antihacker.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/binkevich.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/custom/jaroslaw_tkacz/but_what_can_you_do_about_it.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/kruppzo/mpf_0015.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/cellar/characters/custom/0001.mdl", "cellarFemaleMPF")

ix.anim.SetModelClass("models/cellar/custom/metropolice/cp_engi_male.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/cellar/characters/jessymeth/kramatorsk_tuskerloh.mdl", "cellarFemale")
ix.anim.SetModelClass("models/earlbolat_customs/secondtime/vlk_male_2.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/earlbolat_customs/secondtime/vlk_female_1.mdl", "cellarFemaleMPF")

ix.anim.SetModelClass("models/cellar/characters/oldcitizens/johnlaw.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/custom/metropolice/beres.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/cellar/characters/jessymeth/male_mccooper_reborn.mdl", "cellarMale")

ix.anim.SetModelClass("models/jwk987/cod/ghost/keegan.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/zvezdochka/radiohim.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/custom/jaroslaw_tkacz/vova_adidas.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/cellar/characters/male_kostoprav.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/metropolice/folvixiii.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/kruppzo/retribution_male.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/cellar/characters/rolton.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/greenwood.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/ciri_costume2.mdl", "cellarFemale")
ix.anim.SetModelClass("models/big.mdl", "cellarMale")
ix.anim.SetModelClass("models/saygon.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellarcustom/florensio.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/cellar/custom/viper/viper.mdl", "cellarMale")
ix.anim.SetModelClass("models/kruppzo/borzedit/ihateyoudiscle.mdl", "cellarMale")
ix.anim.SetModelClass("models/jyja.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/goidler.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/custom/borzykh/tyr.mdl", "cellarMale")
ix.anim.SetModelClass("models/kruppzo/velt.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/bobka.mdl", "cellarMale")
ix.anim.SetModelClass("models/realboss.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/custom/enot.mdl", "cellarFemale")

ix.anim.SetModelClass("models/jigul/boar_police.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/cellar/characters/custom_metropolice/female.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/cellar/characters/custom_metropolice/male.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/cellar/characters/metropolice/male/cca_male_valtan.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/ayanamy.mdl", "cellarFemale")

ix.anim.SetModelClass("models/us_engineer.mdl", "cellarMale")
ix.anim.SetModelClass("models/custom_models/hairdryer.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/cellar/characters/city8/citizens/sb/vector.mdl", "cellarMaleMPF")

ix.anim.SetModelClass("models/vintagethief/leon_fem12.mdl", "cellarFemale")
ix.anim.SetModelClass("models/earlbolat_customs/secondtime/vlk_female_1anim.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/cellar/characters/custom_metropolice/kubiq.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/cellar/made_in_germany/jojik_boar.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/cellar/zaebalo_modeli_delat/pedovka.mdl", "cellarFemale")
ix.anim.SetModelClass("models/sharaj00/alanwake_1/florensio_1/female_10_custom.mdl", "cellarFemale")
ix.anim.SetModelClass("models/sharaj00/alanwake_1/florensio_1/male_11_custom.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/female_10_custom.mdl", "cellarFemale")
ix.anim.SetModelClass("models/devil.mdl", "cellarMale")
ix.anim.SetModelClass("models/legat.mdl", "cellarMale")
ix.anim.SetModelClass("models/nevix.mdl", "cellarMale")
ix.anim.SetModelClass("models/virus.mdl", "cellarMale")
ix.anim.SetModelClass("models/bruh.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/characters/custom/thannotpan.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/custom/jaroslaw_tkacz/a_ya_eby_chtoli.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/scott.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/haroto.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/custom/prince.mdl", "cellarMale")
ix.anim.SetModelClass("models/rere/rere.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/characters/custom_metropolice/ushist.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/citizens/citizen_philipia.mdl", "cellarFemale")
ix.anim.SetModelClass("models/earlbolat_customs/secondtime/vlk_male_2new.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/benleyte/mpf_0134.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/328.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/cellar/characters/kartman.mdl", "cellarMale")

ix.anim.SetModelClass("models/oisusy.mdl", "cellarFemaleMPF")

ix.anim.SetModelClass("models/chicha.mdl", "cellarMale")
ix.anim.SetModelClass("models/qond.mdl", "cellarMale")
ix.anim.SetModelClass("models/saltybars.mdl", "cellarMale")
ix.anim.SetModelClass("models/benleyte/female_axilia.mdl", "cellarFemale")
ix.anim.SetModelClass("models/kruppzo/mpf_0405.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/bybig/kiverg.mdl", "cellarMale")

ix.anim.SetModelClass("models/cellar/characters/jessymeth/male_riffevilman.mdl", "cellarMale")
ix.anim.SetModelClass("models/alanwake/asd_repack_ot_earl.mdl", "cellarMale")
ix.anim.SetModelClass("models/dachau/NWU/NWU_TYPE_1_NPC.mdl", "cellarMale")

ix.anim.SetModelClass("models/ermamka/female_offline.mdl", "cellarFemale")
ix.anim.SetModelClass("models/dachau/rs/rso_npc.mdl", "cellarMale")
ix.anim.SetModelClass("models/kruppzo/female_sakomoto.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/characters/folyngys.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/female_wein.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/female_absolutely.mdl", "cellarFemale")
ix.anim.SetModelClass("models/kruppzo/mpf_overseer.mdl", "cellarFemaleMPF")

ix.anim.SetModelClass("models/benleyte/female_kriegid.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/female_ingrid.mdl", "cellarFemale")

ix.anim.SetModelClass("models/benleyte/female_bobring.mdl", "cellarFemale")
ix.anim.SetModelClass("models/quylar/quylar.mdl", "cellarMale")
ix.anim.SetModelClass("models/folyngys/folyngys_coat.mdl", "cellarMale")
ix.anim.SetModelClass("models/benleyte/male_golikov.mdl", "cellarMale")
ix.anim.SetModelClass("models/mirrorka/male_lastfield.mdl", "cellarMale")

ix.anim.SetModelClass("models/cellar/characters/oldcitizens/hekkra/male_09.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/hekkra/male_07.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/hekkra/male_05.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/hekkra/female_07.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/hekkra/female_11.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/hekkra/female_14.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/female_dominq.mdl", "cellarFemale")
ix.anim.SetModelClass("models/player/moonlydays/yaposhka_suit.mdl", "cellarMale")

ix.anim.SetModelClass("models/cellar/characters/oldcitizens/male_caleb.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/zhuniper_zarakane.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/male_erka.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/custom/thannotpan.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/female_winterson.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/female_hoffman.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/male_white.mdl", "cellarMale")
ix.anim.SetModelClass("models/benleyte/male_retribution.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/benleyte/male_retribution_perseus.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/dizcordum/citizens/veletskiy.mdl", "cellarMale")
ix.anim.SetModelClass("models/benleyte/male_erka_crime.mdl", "cellarMale")
ix.anim.SetModelClass("models/benleyte/male_erka_worker.mdl", "cellarMale")
ix.anim.SetModelClass("models/benleyte/female_narkiz.mdl", "cellarFemale")
ix.anim.SetModelClass("models/benleyte/male_chicha_retribution.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/benleyte/female_retribution_chief.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/female_49.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/benleyte/male_rebelZ.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/characters/oldcitizens/female_shtefanov.mdl", "cellarFemale")
ix.anim.SetModelClass("models/mirrorka/8878/mirrorka_8878.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/player/lendshend/lendshend.mdl", "cellarMale")
ix.anim.SetModelClass("models/sb/retribution_raskol.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/ermamka/tomito.mdl", "cellarFemale")
ix.anim.SetModelClass("models/cellar/characters/Clover/male_07.mdl", "cellarMale")
ix.anim.SetModelClass("models/mirrorka/7601/veremut_7601.mdl", "cellarMaleMPF")
ix.anim.SetModelClass("models/cellar/characters/sebastian_schtoltz/sebastian.mdl", "cellarMale")
ix.anim.SetModelClass("models/by_big/Will0w18.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/by_big/bruh.mdl", "cellarMale")
ix.anim.SetModelClass("models/kruppzo/female_mops.mdl", "cellarFemale")
ix.anim.SetModelClass("models/player/ermamka/wheatley.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/nicolas_schultz.mdl", "cellarMale")
ix.anim.SetModelClass("models/santopadre/diper/diper_miller.mdl", "cellarMale")
...
ix.anim.SetModelClass("models/qond.mdl", "cellarMale")
ix.anim.SetModelClass("models/saltybars.mdl", "cellarMale")
ix.anim.SetModelClass("models/che_pm.mdl", "cellarOTA")
ix.anim.SetModelClass("models/benleyte/female_axilia.mdl", "cellarFemale")
ix.anim.SetModelClass("models/kruppzo/mpf_0405.mdl", "cellarFemaleMPF")
ix.anim.SetModelClass("models/bybig/kiverg.mdl", "cellarMale")
...
ix.anim.SetModelClass("models/jq/hlvr/characters/combine_soldier/combine_soldier_new_content_player.mdl", "cellarOTA")
ix.anim.SetModelClass("models/jq/hlvr/characters/combine_soldier/combine_soldier_new_content_super_player.mdl", "cellarOTA")
ix.anim.SetModelClass("models/jq/hlvr/characters/combine_soldier/combine_soldier_new_content_npc.mdl", "cellarOTA")
ix.anim.SetModelClass("models/jq/hlvr/characters/combine_soldier/combine_soldier_new_content_ragdoll.mdl", "cellarOTA")
