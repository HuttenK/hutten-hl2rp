ITEM.name = "Дробовик M590"
ITEM.description = "Помповый дробовик компании Моссберг & Сонс. Отличается своей надежностью и популярностью среди любителей самообороны. Сейчас же используется некоторыми частями Гражданской Обороны в нелетальном варианте."
