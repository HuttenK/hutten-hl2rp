ITEM.name = "item.mpf_investigator_ofc"
ITEM.description = "item.mpf_investigator_ofc.desc"
...
ITEM.uniform = 3
ITEM.primaryVisor = Vector(0.1, 0.1, 2)
ITEM.secondaryVisor = Vector(0.75, 0, 1)
