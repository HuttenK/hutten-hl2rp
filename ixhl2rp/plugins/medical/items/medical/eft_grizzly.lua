...
local def = ix.Medicine.Catalog["eft_grizzly"]
ITEM.name = def.name
ITEM.description = "Большой запас перевязочных средств. Для переломов используйте шину или CMS."
