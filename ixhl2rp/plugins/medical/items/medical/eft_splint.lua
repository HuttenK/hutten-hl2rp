...
local def = ix.Medicine.Catalog["eft_splint"]
ITEM.name = def.name
ITEM.description = "Фиксирует один перелом выбранной конечности. Болевые ограничения снимаются после лечения."
