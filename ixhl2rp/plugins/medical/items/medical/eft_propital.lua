...
local def = ix.Medicine.Catalog["eft_propital"]
ITEM.name = def.name
ITEM.description = "Временная поддержка сознания, лечение ран и подавление боли на 4 минуты."
