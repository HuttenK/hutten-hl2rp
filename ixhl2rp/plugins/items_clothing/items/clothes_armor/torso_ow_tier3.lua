ITEM.name = "Бронежилет армии Надзора"
ITEM.model = "models/autonomous/africa/items/prop_army_vest.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
...
ITEM.rarity = 1
ITEM.description = "Стандартный бронежилет регулярной армии Надзора"
