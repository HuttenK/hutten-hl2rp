...
function ITEM:GetPrintName()
	if (!CLIENT) then return self.name end
...
function ITEM:GetDescription()
	if (!CLIENT) then return self.description end
	local success, result = pcall(L, tostring(self.description or "noDesc"))
	return success and result or self.description
end
