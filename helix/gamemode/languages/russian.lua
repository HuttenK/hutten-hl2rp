...
charcreate_visual						= "ВНЕШНОЕ ОПИСАНИЕ"
...
charcreate_attributes					= "ХАРАКТЕРИСТИКИ  /// СОЗДАНИЕ ПЕРСОНАЖА"
charcreate_available					= "ДОСТУПНО"
charcreate_freePoints					= "СВОБОДНЫХ ОЧКОВ"
charcreate_choose						= "ВЫБЕРИТЕ"
charcreate_primaryAttributes			= "ОСНОВНЫХ АТРИБУТА"
charcreate_primaryAttribute				= "ОСНОВНОЙ АТРИБУТ"
charcreate_primaryAttributeDesc			= "ХАРАКТЕРИСТИКА ПЕРСОНАЖА"
charcreate_primaryAttributeHint			= "Влияет на стоимость повышения характеристики персонажа. Основная характеристика повышается без штрафов, в то время как стоимость остальных характеристик будет составлять 4 очка."
charcreate_citizen						= "ГРАЖДАНИН"
tab_characteristics						= "ХАРАКТЕРИСТИКИ"
tab_health								= "СОСТОЯНИЕ ЗДОРОВЬЯ"
tab_info								= "РОЛЕВАЯ ИНФОРМАЦИЯ"
tab_perks								= "ПЕРКИ"
tab_equipment							= "СНАРЯЖЕНИЕ"
label_cid								= "ГРАЖДАНСКИЙ НОМЕР"
panel_developing							= "Панель находится на стадии разработки."
tab_character								= "ПЕРСОНАЖ"
tab_equip_outer							= "ВЕРХНЯЯ ОДЕЖДА"
tab_equip_under							= "НИЖНЯЯ ОДЕЖДА"
tab_craft									= "СОЗДАНИЕ ВЕЩЕЙ"
tab_to_mainmenu							= "В ГЛАВНОЕ МЕНЮ"
...
tab_tokens									= "ТОКЕНОВ"
tab_level									= "УРОВЕНЬ"
tab_xp_until								= "ДО СЛЕДУЮЩЕГО: %s XP"
tab_profile								= "ПРОФИЛЬ ПЕРСОНАЖА"
tab_basics									= "ОСНОВНОЕ"
tab_phys_desc								= "ФИЗИЧЕСКОЕ ОПИСАНИЕ"
tab_appearance_desc						= "ВНЕШНЕЕ ОПИСАНИЕ"
tab_notes									= "ЛИЧНЫЕ ЗАПИСИ"
tab_skills									= "НАВЫКИ"
tab_special_tooltip						= "ХАРАКТЕРИСТИКА ПЕРСОНАЖА"
tab_consciousness							= "СОЗНАНИЕ:"
tab_pain									= "БОЛЬ:"
tab_hunger									= "ГОЛОД:"
tab_thirst									= "ЖАЖДА:"
tab_health_label							= "ЗДОРОВЬЕ:"
tab_backpack								= "РЮКЗАК"
tab_slot_torso								= "ТОРС"
tab_slot_head								= "ГОЛОВА"
tab_slot_legs								= "НОГИ"
tab_slot_face								= "ЛИЦО"
tab_slot_ears								= "УШИ"
tab_slot_shoulder							= "ПЛЕЧО"
tab_slot_hands								= "РУКИ"
tab_radio									= "РАЦИЯ"
tab_name									= "ИМЯ"
tab_gender									= "ПОЛ"
...
Outfit									= "Одежда"
Weapons									= "Оружие"
itemContrabandWarning						= "Является контрабандой: хранение и транспортировка запрещена."
purchase								= "Купить"
purchasing								= "Покупка..."
success									= "Успешно"
...
charDeleted								= "Персонаж %s был удален!"
...
option.openBags							= "Открывать сумки в инвентаре "
option.openBags.desc					= "При открытии меню, автоматически открывает все сумки в вашем инвентаре."
option.showIntro						= "Интро при подключении"
option.showIntro.desc					= "Показывает интро фреймворка при следующем подключении. Автоматически отключается после просмотра."
option.cheapBlur						= "Отключить блюр"
option.cheapBlur.desc					= "Заменяет блюр в интерфейсе на простое затемнение."
option.observerTeleportBack				= "Возвращение на место"
option.observerTeleportBack.desc		= "Возвращает вас к месту, в котором вы вошли в режим наблюдения."
option.observerESP						= "Админ ESP"
option.observerESP.desc					= "Показывает имена и местоположение каждого игрока на сервере."
option.hour24Time						= "24-часовой формат времени"
option.hour24Time.desc					= "Показывать время в 24-х часовом формате, вместо 12 часового (AM/PM)."
option.chatNotices						= "Уведомления в чате"
option.chatNotices.desc					= "Выводит все уведомления которые появляются в правом верхнем углу в текстовый чат."
option.chatTimestamps					= "Время в чате"
option.chatTimestamps.desc				= "Отмечает время отправки кажого сообщения в чате."
option.alwaysShowBars					= "Всегда показывать информационную панель"
option.alwaysShowBars.desc				= "Отображает состояние персонажа в левом верхнем углу на постоянной основе."
option.altLower							= "Опуская, скрывать руки" -- @todo remove m
option.altLower.desc					= "Скрывать руки, при опускани оных." -- @todo remove m
option.thirdpersonEnabled				= "|Третье лицо"
option.thirdpersonEnabled.desc			= "Перемещение камеры позади вас. Также переключается консольной командой \'ix_togglethirdperson\'"
option.thirdpersonClassic				= "|Классическая камера"
option.thirdpersonClassic.desc			= "Управлять взглядом вашего персонажа с помощью мыши."
option.thirdpersonVertical				= "Высота камеры"
option.thirdpersonVertical.desc			= "Высота расположения камеры от 3 лица."
option.thirdpersonHorizontal			= "Камера по горизонтали"
option.thirdpersonHorizontal.desc		= "Расположение камеры влево или вправо от персонажа."
option.thirdpersonDistance				= "Расстояние камеры"
option.thirdpersonDistance.desc			= "Как далеко располагается камера от персонажа."
option.thirdpersonCrouchOffset			= "Высота камеры при присяде"
option.thirdpersonCrouchOffset.desc		= "Высота расположения камеры от 3 лица."
option.disableAnimations				= "Отключить анимации интерфейса"
option.disableAnimations.desc			= "Отключает анимации интерфейса, для резкого перехода между окнами."
option.animationScale					= "Скорость анимаций"
option.animationScale.desc				= "Насколько быстрее или медленнее проигрывается анимация."
option.language							= "Язык"
option.language.desc					= "Язык интерфейса Helix."
option.minimalTooltips					= "Минималистичные подсказки"
option.minimalTooltips.desc				= "Изменяет стиль показа подсказок, чтобы занимать меньше места."
option.noticeDuration					= "Длительность уведомления"
option.noticeDuration.desc				= "Как долго показываются уведомления (в секундах)."
option.noticeMax						= "Максимальное кол-во уведомлений"
option.noticeMax.desc					= "Количество уведомлений, показываемых одновременно."
option.chatFontScale					= "Шрифт чата"
option.chatFontScale.desc				= "Насколько больше или меньше шрифт чата должен быть."
option.chatOutline						= "Контур в чате"
option.chatOutline.desc					= "Рисует контур вокруг текста в чате. Включите, если у вас проблемы с чтением чата."
option.show3DPanels 					= "Показывать пользовательские изображения"
...
-- Temp Flags
cmd.char.tempflags.give = "Выдать персонажу временные флаги. Время указано в минутах."
cmd.char.tempflags.extend = "Продлить (или сократить) текущие временные флаги персонажа. Они пропадут через отведенное количество времени."
cmd.char.tempflags.take = "Забрать временные флаги у персонажа."
cmd.char.tempflags.clear = "Забрать все временные флаги у персонажа."
cmd.char.tempflags.check = "Проверить флаги персонажа."

tempflags.give = "%s выдал %s '%s' флаги на %d минут."
tempflags.alreadyGiven = "%s уже имеет флаги '%s', или эти флаги несуществуют."
tempflags.alreadyTaken = "%s не имеет '%s' флагов."
tempflags.take = "%s забрал '%s' временные флаги у %s."
tempflags.noClear = "%s не имеет никаких временных флагов."
tempflags.expired = "Временные флаги персонажа %s '%s' истекли."
tempflags.expireWarn = "Ваши временные '%s' флаги истекут через 5 минут."
...
storageCloseHint						= "[TAB] — закрыть хранилище"
...
equip.radio								= "РАЦИЯ"
equip.ears								= "УШИ"
equip.shoulder							= "ПЛЕЧО"
equip.legs								= "НОГИ"
equip.hands								= "РУКИ"
equip.backpack							= "РЮКЗАК"
equip.you								= "ВЫ"

body.fullBody							= "ВСЁ ТЕЛО"
body.head								= "Голова"
body.torso								= "Торс"
body.stomach							= "Живот"
body.leftArm							= "Левая рука"
body.rightArm							= "Правая рука"
body.leftLeg							= "Левая нога"
body.rightLeg							= "Правая нога"

ui.close								= "ЗАКРЫТЬ"
ui.searchEnter							= "Нажмите Enter для поиска"
ui.searchBtn							= "Нажмите для поиска"
ui.searchResults						= "%s результатов для \"%s\""

chargen.faceLabel						= "ЛИЦО: "
chargen.hairLabel						= "ВОЛОСЫ: "
chargen.attribute						= "ХАРАКТЕРИСТИКА ПЕРСОНАЖА"
chargen.heightFmt						= "%%s см"

mainmenu.x86Warning						= "Установите x86-64 версию игры."
mainmenu.needCharacter					= "У вас должен быть хотя бы один персонаж!"

mainmenu.btnNewArrival					= "НОВОЕ ПРИБЫТИЕ"
mainmenu.btnCharacters					= "ПЕРСОНАЖИ"
mainmenu.btnContent						= "КОНТЕНТ"
mainmenu.btnInfo						= "ИНФОРМАЦИЯ"
mainmenu.btnClose						= "ЗАКРЫТЬ"
mainmenu.hintTitle						= "ГРАЖДАНСКАЯ ОБОРОНА"
mainmenu.hintText						= "Сотрудники Гражданской Обороны — это не только игроки, которые призваны избивать других игроков, но они также являются интересными персонажами. Несмотря на то, что сотрудники, обычно, немногословны, многие из них подвержены коррупции и могут иметь связи с Сопротивлением. Всегда обращайтесь к сотрудникам, если желаете что-то узнать или рассказать."
mainmenu.versionLabel					= "ВЕРСИЯ #28"
mainmenu.warningText					= "Защищено системой анонимности версии 5."
mainmenu.patchTitle						= "Патч 28.6:"
mainmenu.patchCore						= "ЯДРО:"
mainmenu.patchCoreText					= "Подготовка ядра к запланированным изменениям интерфейса."
mainmenu.patchDate						= "22.09.2024:"
mainmenu.patchNew						= "НОВОЕ:"
mainmenu.patchNewText					= "Добавлены предметы: Черные брюки, Белые брюки, Черные брюки с ремнем, Черный пиджак, Белый пиджак, Черный пиджак с пальто."
