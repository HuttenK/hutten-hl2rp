...
ix.config.Add("walkSpeed", 65, "How fast a player normally walks.", function(oldValue, newValue)
...
ix.config.Add("runSpeed", 180, "How fast a player normally runs.", function(oldValue, newValue)
	for _, v in ipairs(player.GetAll())	do
